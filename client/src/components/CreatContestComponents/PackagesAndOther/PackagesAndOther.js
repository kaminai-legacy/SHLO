        ...
        <>
            ...
            <div className={style.flexCategoriesRow}>
                <CardCategories name={"Name + Logo"} contestType={['NAME','LOGO']}
                                ...
                                link={'/home'} click={props.selectedContestType} alsoClick={props.contestProgressing} currentStage={2}/>
                ...
                <CardCategories name={"Name + Logo + Tagline"} click={props.selectedContestType} alsoClick={props.contestProgressing} contestType={['NAME','TAGLINE_OR_SLOGAN','LOGO']}
                                text={"Establish your entire brand identity and save with this bundle."} currentStage={2}
                ...
                <CardCategories name={"Logo + Tagline"} text={"Description for Logo + Tagline will come here"}
                                img={[CONTEST_IMGS.logo, CONTEST_IMGS.taglineOrSlogan]} click={props.selectedContestType} alsoClick={props.contestProgressing} contestType={['TAGLINE_OR_SLOGAN','LOGO']}
