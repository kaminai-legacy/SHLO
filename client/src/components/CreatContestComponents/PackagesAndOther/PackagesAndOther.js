        ...
        <>
            ...
            <div className={style.flexCategoriesRow}>
                <CardCategories name={"Name + Logo"}
                                ...
                                link={'/home'}/>
                <CardCategories name={"Name + Logo + Business Cards"}
                                text={"Get the branding essentials plus matching business cards and save"}
                                img={[CONTEST_IMGS.name[0], CONTEST_IMGS.logo[0]]}
                                imgHover={[CONTEST_IMGS.name[1], CONTEST_IMGS.logo[1]]} styles={"#f5f5f5"}
                                link={'/home'}/>
                <CardCategories name={"Name + Tagline"}
                                text={"GCommunicate your vision with the perfect Name/Tagline combo."}
                                ...
                                link={'/home'}/>
                <CardCategories name={"Name + Logo + Tagline"}
            ...
            <div className={style.flexCategoriesRow}>
                <CardCategories name={"Logo + Business Cards"}
                ...
                <CardCategories name={"Logo + Tagline"} text={"Description for Logo + Tagline will come here"}
                                img={[CONTEST_IMGS.logo[0], CONTEST_IMGS.taglineOrSlogan[0]]}
                                imgHover={[CONTEST_IMGS.logo[1], CONTEST_IMGS.taglineOrSlogan[1]]} styles={"#f5f5f5"}
                                link={'/home'}/>
                <CardCategories name={"Logo + Business Cards + Stationery"}
