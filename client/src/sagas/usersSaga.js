...
import {getUserLogin, signUpLogin,checkEmail,createApiLink,changePassword} from '../api/rest/restContoller';
    ...
    try {
        ...
        if (dataToSend.title==='Let\'s Get Started'){
            ...
            if(data.result==="has Email"){
                ...
                yield put({type: ACTION.GET_MAIL_SERVICE_RESULT, result:data,err:false,otherData:{resetPasswordView:false}});
